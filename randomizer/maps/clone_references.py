...
def _clone_reference_rules(
    ...
    # Authored Events and Actions always retain native TechnoType IDs. A
    # trigger may compare, create, delete, or count an exact type regardless of
    # its owner. Rewriting such references to player-production clones can
    # silently break mission progress or failure conditions.
