...
from randomizer.rewards.reloaded_definitions import UNIT_SIDEBAR_IMAGES
...
GENERATED_ART_MARKER = (
    '; Generated by C&C Reloaded Randomizer Launcher unit cameo overlay'
)
...
def deploy_generated_unit_art(
    ...
    """Deploy optional generated cameo aliases when an art cache exists."""
    ...
    if not art_cache.is_file():
        # Reloaded clone rules retain each source type's native Image/Cameo.
        # Unlike Mental Omega, no extracted art override is required for the
        # runnable access-and-buff core. An explicitly requested cache remains
        # strict for diagnostics and developer tooling.
