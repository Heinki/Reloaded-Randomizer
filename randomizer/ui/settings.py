...
def _build_gameplay_settings(self, settings_frame):
    ...
    WidgetTooltip(
        ...
        'Includes mapper-reviewed optional C&C Reloaded operations. These are '
        'excluded from both the next mission seed and Advanced Pool when disabled.',
    )
    ...
    WidgetTooltip(
        ...
        'Grants mapper-reviewed basic units matching each Reloaded production '
        'family available in the mission. Starter units remain buffable.',
    )
    ...
    WidgetTooltip(
        ...
        'Unlocks mapper-reviewed ground and anti-air defenses for each Reloaded '
        'Construction Yard family available to the player. Structures remain '
        'gated by a matching Construction Yard and remain buffable.',
    )
